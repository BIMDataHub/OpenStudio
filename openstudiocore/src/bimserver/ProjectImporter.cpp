...
namespace bimserver {
  ...
  void ProjectImporter::processSucessCases(QString sucessCase)
  {
    if (sucessCase == "createProject") {
    ...
    } else if (sucessCase == "renameProject") {
      m_bimserverConnection->getAllProjects();
      ...
      m_bimserverConnection->getAllProjects();
      emit loginSuccess();
      //emit loginStatus("<b>Server Status:</b> BIMServer Connected");
    }
  }
  ...
  void ProjectImporter::processBIMserverErrors() {
    ...
    //this->show();
    emit loginFailure();
    //emit loginStatus("<b>Server Status:</b> Fail to Connect");
  }
  ...
  /*
  void ProjectImporter::rnmProject(QString rnmID)
  {
    //m_bimserverConnection->renameProject(rnmID);
  }
  */
